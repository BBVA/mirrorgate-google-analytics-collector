...
You can file new issues by filling out our [new issue form](https://github.com/bbva/mirrorgate-google-analytics-collector/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

Before you submit your Pull Request (PR) consider the following guidelines:

- Search [GitHub](https://github.com/bbva/mirrorgate-google-analytics-collector/pulls) for an open or closed PR
...
Samples: (even more [samples](https://github.com/bbva/mirrorgate-google-analytics-collector/commits/master))
...
```text
  ...
  The version in our build.gradle contains an issue that is causing application to fail during startup.
```
...
[github]: https://github.com/bbva/mirrorgate-google-analytics-collector
